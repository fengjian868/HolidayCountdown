...
public class UnifiedSettingsPage : SettingsPageBase
{
    ...
    Control BuildAboutPanel()
    {
        ...
        changelogPanel.Children.Add(new TextBlock { Text = "- 新增：课程表联动组件 - 读取 ClassIsland 课程表，显示当前课程/课间倒计时", FontSize = 12, Opacity = 0.8 });
        changelogPanel.Children.Add(new TextBlock { Text = "- 新增：学习时长统计组件 - 记录 ClassIsland 运行时长，显示今日学习时长", FontSize = 12, Opacity = 0.8 });
        changelogPanel.Children.Add(new TextBlock { Text = "- 新增：统一设置页 - 顶部横向 Tab 切换所有组件配置", FontSize = 12, Opacity = 0.8 });
        changelogPanel.Children.Add(new TextBlock { Text = "- 新增：本地问候语数据库 - 199 条按标签分类，替代联网刷新", FontSize = 12, Opacity = 0.8 });
        changelogPanel.Children.Add(new TextBlock { Text = "- 新增：农历年度缓存 - 本地缓存一整年农历数据", FontSize = 12, Opacity = 0.8 });
        changelogPanel.Children.Add(new TextBlock { Text = "- 新增：天气问候模板自定义 - 支持预设/自定义模板", FontSize = 12, Opacity = 0.8 });
        changelogPanel.Children.Add(new TextBlock { Text = "- 新增：温度区间提醒自定义 - 自定义各温度区间穿衣提醒文案", FontSize = 12, Opacity = 0.8 });
        changelogPanel.Children.Add(new TextBlock { Text = "- 新增：24节气进度环开关 - 可控制是否显示节气进度环", FontSize = 12, Opacity = 0.8 });
        changelogPanel.Children.Add(new TextBlock { Text = "- 新增：每周提醒自定义日期 - 支持选择周一~周日任意一天", FontSize = 12, Opacity = 0.8 });
        ...
        changelogPanel.Children.Add(new TextBlock { Text = "- 优化：CI 打包体积，删除非 Windows 运行时", FontSize = 12, Opacity = 0.8 });
        ...
        changelogPanel.Children.Add(new TextBlock { Text = "- 修复：PluginSdk 降级到 2.0.0.2 兼容 ClassIsland 稳定版", FontSize = 12, Opacity = 0.8 });
